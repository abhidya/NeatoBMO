...
typedef enum {
    ...
    BMOQ_CONFIG_UNPADDED_VOCAB_SIZE = 5000u,
    BMOQ_CONFIG_SWA_NUM_ATTENTION_HEADS = 5001u,
    BMOQ_CONFIG_SWA_NUM_KEY_VALUE_HEADS = 5002u,
    BMOQ_CONFIG_SWA_HEAD_DIM = 5003u,
    BMOQ_CONFIG_HEAD_DIM = 5004u,
    BMOQ_CONFIG_D_REL = 5005u,
    BMOQ_CONFIG_REL_EXTENT = 5006u,
    BMOQ_CONFIG_CONV_KERNEL = 5007u,
    BMOQ_CONFIG_LOG_SCALING_N_FLOOR = 5008u,
    BMOQ_CONFIG_LOG_SCALING_ALPHA = 5009u,
    BMOQ_CONFIG_DENSE_MLP_INDEX = 5010u,
    BMOQ_CONFIG_SHARED_EXPERTS_INKLING = 5011u,
    BMOQ_CONFIG_LOGITS_MUP_WIDTH_MULTIPLIER = 5012u,
    BMOQ_CONFIG_DENSE_INTERMEDIATE_SIZE = 5013u,
    BMOQ_CONFIG_LOCAL_LAYER_IDS = 5014u,
    BMOQ_CONFIG_SPARSE_LAYER_IDS = 5015u,
} bmoq_config_key_t;
